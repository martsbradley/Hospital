...
{
    PATIENT_SURNAME_SIZE(PatientDTO.class, "surname", "javax.validation.constraints.Size.message"),
    PATIENT_DOB_NOT_NULL(PatientDTO.class, "dob", "javax.validation.constraints.NotNull.message");
